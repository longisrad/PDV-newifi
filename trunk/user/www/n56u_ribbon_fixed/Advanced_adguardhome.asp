						...
						<div class="box well grad_colour_dark_blue">
                            ...
                            <ul class="nav nav-tabs" style="margin-bottom: 10px;">
								...
								<div class="row-fluid">
									...
									<p>AdGuard Home is a network-wide ad blocking and anti-tracking software. Once installed, it covers all your home devices without requiring any client-side software. As IoT and connected devices continue to grow, controlling your entire network environment becomes increasingly important.
									</p>
									AdGuard Home website: <a href="https://adguard.com/" target="blank"><i><u>https://adguard.com/</u></i></a>
									</div>

									<table width="100%" align="center" cellpadding="4" cellspacing="0" class="table">
										<tr>
											<th width="30%" style="border-top: 0 none;">Enable AdGuard Home</th>
