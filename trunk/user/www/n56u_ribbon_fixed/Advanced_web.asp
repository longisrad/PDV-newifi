...
<html>
<head>
<title><#Web_Title#> - <#Web_menu_title#></title>
				...
				<div class="row-fluid">
					<div class="span12">
						<div class="box well grad_colour_dark_blue">
							<h2 class="box_head round_top"><#Web_menu_title#></h2>
							<div class="round_bottom">
								<div class="row-fluid">
									<div id="tabMenu" class="submenuBlock"></div>
									<div class="alert alert-info" style="margin: 10px;"><#Web_menu_desc#></div>
									<table width="100%" align="center" cellpadding="4" cellspacing="0" class="table">
										<tr >
											<th width="50%"><#Web_menu_traffic#></th>
											<td>
										...
										<tr >
											<th width="50%"><#Web_menu_sysinfo#></th>
											<td>
													<div class="main_itoggle">
													<div id="w_sys_on_of">
										...
										<tr >
											<th width="50%"><#Web_menu_usbapp#></th>
											<td>
													<div class="main_itoggle">
													<div id="w_usb_on_of">
										...
										<tr >
											<th width="50%"><#Web_menu_netinfo#></th>
											<td>
													<div class="main_itoggle">
													<div id="w_net_on_of">
										...
										<tr >
											<th width="50%"><#Web_menu_syslog#></th>
											<td>
													<div class="main_itoggle">
													<div id="w_log_on_of">
										...
										<tr id="row_wadbyby" style="display:none">
											<th width="50%"><#Web_menu_adbyby#></th>
											<td>
													<div class="main_itoggle">
