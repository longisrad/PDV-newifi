...
#include "common.h"
	...
	struct evDesc events_desc[] = {
		...
		{EVM_RESTART_SWITCH_VLAN,	EVM_RESTART_SWITCH_VLAN,	RCN_RESTART_SWITCH_VLAN,0},
		...
		{EVM_RESTART_LLTD,		EVM_RESTART_LLTD,		RCN_RESTART_LLTD,	0},
		{EVM_RESTART_ADSC,		EVM_RESTART_ADSC,		RCN_RESTART_ADSC,	0},
		{EVM_RESTART_CROND,		EVM_RESTART_CROND,		RCN_RESTART_CROND,	0},
		{EVM_RESTART_SYSCTL,		EVM_RESTART_SYSCTL,		RCN_RESTART_SYSCTL,	0},
		{EVM_RESTART_TWEAKS,		EVM_RESTART_TWEAKS,		RCN_RESTART_TWEAKS,	0},
		{EVM_RESTART_WDG,		EVM_RESTART_WDG,		RCN_RESTART_WDG,	0},
		{EVM_RESTART_DI,		EVM_RESTART_DI,			RCN_RESTART_DI,		0},
#if defined(USE_USB_SUPPORT)
